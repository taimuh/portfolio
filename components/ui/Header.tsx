            ...
            <div className={STYLES.desktopNavigation}>
              {NAVIGATION.items.map((item) => (
                <a 
                  ...
                  {...(item.label === 'Source' && { target: '_blank', rel: 'noopener noreferrer' })}
                >
                  {item.label === 'Source' && (
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon">
                  ...
                  <span className={STYLES.srOnly}>{UI_TEXT.buttons.openMenu}</span>
                </Button>
              </DropdownMenuTrigger>
...
const STYLES = {
  ...
  navLink: "border-transparent text-gray-500 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600 hover:text-gray-700 dark:hover:text-gray-100 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium",
  githubIcon: "h-5 w-5 mr-1",
  desktopThemeToggle: "hidden sm:ml-6 sm:flex sm:space-x-8 flex items-center text-gray-500 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600 hover:text-gray-700 dark:hover:text-gray-100 mr-4",
