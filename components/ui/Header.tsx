...
const STYLES = {
  ...
  navLink: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium",
  githubIcon: "h-5 w-5 mr-1",
  desktopThemeToggle: "hidden sm:ml-6 sm:flex sm:space-x-8 flex items-center text-gray-500 hover:border-gray-300 hover:text-gray-700 mr-4",
